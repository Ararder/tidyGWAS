...
created inside `/home/cleaned_tidyGWAS`. If `output_dir`is not set, tidyGWAS will 
create a folder inside the R tempdir.
...
inside the folder specified in `output_dir`, you will have the following
files:
