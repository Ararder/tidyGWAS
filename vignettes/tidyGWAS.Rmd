...
motivation for this. In essence, this format will significantly speed up other downstream
applications such as meta-analysis, LD querying and other analyses.

the format can easily be read into memory using `arrow::open_dataset()`
```{r}
