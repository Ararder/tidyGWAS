...
You might have noted that there are there possible arguments to output_format. The last option is "hivestyle", and splits the dataset into separate files based on CHR.

The `vignette("Hivestyle-partitioning")` explains how this format can be used to analyse many summary statistics at the same time, at low memory cost and speed.
...
CPU usage depends heavily on underlying architecture, and CPU.
