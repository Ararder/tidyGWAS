...
The GWAS summary statistics file can be provided in-memory as a data.frame/tibble or a filepath that can be read with data.table::fread. 
We will use the 100k random rows from the PGC wave 3 schizophrenia [GWAS](https://pgc.unc.edu/for-researchers/download-results/) as an example file.
...
Memory use and time scales with the size of the summary statistics.
From running tidyGWAS extensively, here's an estimation of time and memory:
