...
8.  `id` variant ID in the format of `CHR:POS:REF:ALT`

9.  All other valid columns in the input summary statistics file

10. If possible `repair_stats()` will add statistics columns such as
